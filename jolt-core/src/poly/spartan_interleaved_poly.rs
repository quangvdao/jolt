            ...
            .map(|chunk_idx| {
                ...
                for x_out_val in x_out_start..x_out_end {
                    ...
                    for x_in_step_val in 0..num_x_in_step_vals {
                        ...
                        let coeff_start_time_phase2 = std::time::Instant::now();
                        ...
                        chunk_coeff_time += coeff_start_time_phase2.elapsed();
...
/// This is the "middle" version with Gruen's optimization
...
impl<F: JoltField> GruenSpartanInterleavedPolynomial<F> {
    ...
    fn uninterleave(&self) -> (DensePolynomial<F>, DensePolynomial<F>, DensePolynomial<F>) {
        ...
        if !self.is_bound() {
            for shard in &self.unbound_coeffs_shards {
                for coeff in shard {
                    match coeff.index % 3 {
...
/// This is the original version in the Jolt codebase, without Gruen's optimizations nor small-value optimizations
#[derive(Default, Debug, Clone)]
