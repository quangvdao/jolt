...
fn append_g1_add_virtual_claims<F: JoltField, T: Transcript>(
    ...
    let claims = virtual_claims![
        VirtualPolynomial::g1_add_xp(constraint_idx) => x_p,
        VirtualPolynomial::g1_add_yp(constraint_idx) => y_p,
        VirtualPolynomial::g1_add_p_indicator(constraint_idx) => ind_p,
        VirtualPolynomial::g1_add_xq(constraint_idx) => x_q,
        VirtualPolynomial::g1_add_yq(constraint_idx) => y_q,
        VirtualPolynomial::g1_add_q_indicator(constraint_idx) => ind_q,
        VirtualPolynomial::g1_add_xr(constraint_idx) => x_r,
        VirtualPolynomial::g1_add_yr(constraint_idx) => y_r,
        VirtualPolynomial::g1_add_r_indicator(constraint_idx) => ind_r,
        VirtualPolynomial::g1_add_lambda(constraint_idx) => lambda,
        VirtualPolynomial::g1_add_inv_delta_x(constraint_idx) => inv_delta_x,
        VirtualPolynomial::g1_add_is_double(constraint_idx) => is_double,
        VirtualPolynomial::g1_add_is_inverse(constraint_idx) => is_inverse,
    ];
...
fn get_g1_add_virtual_claims<F: JoltField>(
    ...
    let polynomials = vec![
        VirtualPolynomial::g1_add_xp(constraint_idx),
        VirtualPolynomial::g1_add_yp(constraint_idx),
        VirtualPolynomial::g1_add_p_indicator(constraint_idx),
        VirtualPolynomial::g1_add_xq(constraint_idx),
        VirtualPolynomial::g1_add_yq(constraint_idx),
        VirtualPolynomial::g1_add_q_indicator(constraint_idx),
        VirtualPolynomial::g1_add_xr(constraint_idx),
        VirtualPolynomial::g1_add_yr(constraint_idx),
        VirtualPolynomial::g1_add_r_indicator(constraint_idx),
        VirtualPolynomial::g1_add_lambda(constraint_idx),
        VirtualPolynomial::g1_add_inv_delta_x(constraint_idx),
        VirtualPolynomial::g1_add_is_double(constraint_idx),
        VirtualPolynomial::g1_add_is_inverse(constraint_idx),
    ];
