...
## Appendix — Updated verification numbers (after GT inlines + dory-pcs wiring)

**Run (trace-only, release, recursion/fibonacci, embed):**
`RUST_LOG=info cargo run -p recursion --release trace --example fibonacci --embed`

**Relevant commits (branch `quang/gt-exp-inlines`):**
