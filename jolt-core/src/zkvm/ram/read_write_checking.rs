...
pub struct RamReadWriteCheckingProver<F: JoltField> {
    pub sparse_matrix_phase1: ReadWriteMatrixCycleMajor<F>,
    pub sparse_matrix_phase2: ReadWriteMatrixAddressMajor<F>,
    pub gruen_eq: Option<GruenSplitEqPolynomial<F>>,
