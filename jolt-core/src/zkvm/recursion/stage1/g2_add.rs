...
fn append_g2_add_virtual_claims<F: JoltField, T: Transcript>(
    ...
    let claims = virtual_claims![
        VirtualPolynomial::g2_add_xp_c0(constraint_idx) => x_p_c0,
        VirtualPolynomial::g2_add_xp_c1(constraint_idx) => x_p_c1,
        VirtualPolynomial::g2_add_yp_c0(constraint_idx) => y_p_c0,
        VirtualPolynomial::g2_add_yp_c1(constraint_idx) => y_p_c1,
        VirtualPolynomial::g2_add_p_indicator(constraint_idx) => ind_p,
        VirtualPolynomial::g2_add_xq_c0(constraint_idx) => x_q_c0,
        VirtualPolynomial::g2_add_xq_c1(constraint_idx) => x_q_c1,
        VirtualPolynomial::g2_add_yq_c0(constraint_idx) => y_q_c0,
        VirtualPolynomial::g2_add_yq_c1(constraint_idx) => y_q_c1,
        VirtualPolynomial::g2_add_q_indicator(constraint_idx) => ind_q,
        VirtualPolynomial::g2_add_xr_c0(constraint_idx) => x_r_c0,
        VirtualPolynomial::g2_add_xr_c1(constraint_idx) => x_r_c1,
        VirtualPolynomial::g2_add_yr_c0(constraint_idx) => y_r_c0,
        VirtualPolynomial::g2_add_yr_c1(constraint_idx) => y_r_c1,
        VirtualPolynomial::g2_add_r_indicator(constraint_idx) => ind_r,
        VirtualPolynomial::g2_add_lambda_c0(constraint_idx) => lambda_c0,
        VirtualPolynomial::g2_add_lambda_c1(constraint_idx) => lambda_c1,
        VirtualPolynomial::g2_add_inv_delta_x_c0(constraint_idx) => inv_dx_c0,
        VirtualPolynomial::g2_add_inv_delta_x_c1(constraint_idx) => inv_dx_c1,
        VirtualPolynomial::g2_add_is_double(constraint_idx) => is_double,
        VirtualPolynomial::g2_add_is_inverse(constraint_idx) => is_inverse,
    ];
...
fn get_g2_add_virtual_claims<F: JoltField>(
    ...
    let polynomials = vec![
        VirtualPolynomial::g2_add_xp_c0(constraint_idx),
        VirtualPolynomial::g2_add_xp_c1(constraint_idx),
        VirtualPolynomial::g2_add_yp_c0(constraint_idx),
        VirtualPolynomial::g2_add_yp_c1(constraint_idx),
        VirtualPolynomial::g2_add_p_indicator(constraint_idx),
        VirtualPolynomial::g2_add_xq_c0(constraint_idx),
        VirtualPolynomial::g2_add_xq_c1(constraint_idx),
        VirtualPolynomial::g2_add_yq_c0(constraint_idx),
        VirtualPolynomial::g2_add_yq_c1(constraint_idx),
        VirtualPolynomial::g2_add_q_indicator(constraint_idx),
        VirtualPolynomial::g2_add_xr_c0(constraint_idx),
        VirtualPolynomial::g2_add_xr_c1(constraint_idx),
        VirtualPolynomial::g2_add_yr_c0(constraint_idx),
        VirtualPolynomial::g2_add_yr_c1(constraint_idx),
        VirtualPolynomial::g2_add_r_indicator(constraint_idx),
        VirtualPolynomial::g2_add_lambda_c0(constraint_idx),
        VirtualPolynomial::g2_add_lambda_c1(constraint_idx),
        VirtualPolynomial::g2_add_inv_delta_x_c0(constraint_idx),
        VirtualPolynomial::g2_add_inv_delta_x_c1(constraint_idx),
        VirtualPolynomial::g2_add_is_double(constraint_idx),
        VirtualPolynomial::g2_add_is_inverse(constraint_idx),
    ];
