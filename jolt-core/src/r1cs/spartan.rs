    ...
    ProofTranscript: Transcript,
{
    ...
    /// Prove Spartan where the first sumcheck uses small value optimizations
    /// The rest are the same
    #[tracing::instrument(skip_all, name = "Spartan::prove_small_value")]
    pub fn prove_small_value<PCS>(
        constraint_builder: &CombinedUniformBuilder<C, F, I>,
        ...
        PCS: CommitmentScheme<ProofTranscript, Field = F>,
    {
        ...
        // drop_in_background_thread((az_bz_cz_poly));
