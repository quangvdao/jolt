...
// pub trait OptimizedMulPlusMinus<Plus, Minus>:
//     Sized + Add<Plus, Output = Plus> + Mul<Plus, Output = Plus> + Sub<Minus, Output = Minus>
// {
//     fn mul_0_pm_1_optimized(self, plus: Plus, minus: Minus) -> Self::Output;
// }

// impl<T> OptimizedMulPlusMinus<T, T> for T
// where
//     T: JoltField,
// {
//     fn mul_0_pm_1_optimized(self, plus: T, minus: T) -> T {
//         if self.is_zero() {
//             Self::zero()
//         } else if self.is_one() {
//             plus += self;
