...
use crate::{
    ...
    zkvm::recursion::constraints::system::G2ScalarMulNative,
    zkvm::recursion::g2::types::G2ScalarMulPublicInputs,
    zkvm::recursion::gt::types::{
        eq_lsb_evals, eq_lsb_mle, eq_plus_one_lsb_evals, eq_plus_one_lsb_mle,
    },
    zkvm::witness::{G2ScalarMulTerm, RecursionPoly, VirtualPolynomial},
};
...
impl SumcheckInstanceParams<Fq> for G2ScalarMulParams {
...
impl G2ScalarMulProver {
    pub fn new<T: Transcript>(
        ...
        let params = G2ScalarMulParams::new(rows.len());
    ...
    pub fn new_with_k_common<T: Transcript>(
        ...
        debug_assert_eq!(rows.len(), public_inputs.len());
        let params = G2ScalarMulParams::new_with_k_common(rows.len(), k_common);
        Self::new_with_params(rows, public_inputs, params, transcript)
    }
...
impl<FqT: Transcript> SumcheckInstanceProver<Fq, FqT> for G2ScalarMulProver {
    ...
    fn compute_message(&mut self, _round: usize, previous_claim: Fq) -> UniPoly<Fq> {
        ...
        let total_evals: [Fq; DEGREE] = (0..half)
            ...
            .map(|idx| {
                ...
                for t in 0..DEGREE {
                    let vals = G2ScalarMulValues::from_poly_evals(&poly_evals, t);
    ...
    fn cache_openings(
        ...
        for (vp, claim) in [
            ...
            (
                ...
                self.x_p_c0.get_bound_coeff(0),
            ),
            (
                VirtualPolynomial::Recursion(RecursionPoly::G2ScalarMul {
                    term: G2ScalarMulTerm::XPC1,
                }),
                self.x_p_c1.get_bound_coeff(0),
            ),
            (
                VirtualPolynomial::Recursion(RecursionPoly::G2ScalarMul {
                    term: G2ScalarMulTerm::YPC0,
                }),
                self.y_p_c0.get_bound_coeff(0),
            ),
            (
                VirtualPolynomial::Recursion(RecursionPoly::G2ScalarMul {
                    term: G2ScalarMulTerm::YPC1,
                }),
                self.y_p_c1.get_bound_coeff(0),
            ),
        ] {
            let op = if matches!(
                vp,
                VirtualPolynomial::Recursion(RecursionPoly::G2ScalarMul {
                    term: G2ScalarMulTerm::XPC0
                        | G2ScalarMulTerm::XPC1
                        | G2ScalarMulTerm::YPC0
                        | G2ScalarMulTerm::YPC1
                })
            ) {
            ...
            accumulator.append_virtual(transcript, vp, SumcheckId::G2ScalarMul, op, claim);
        }
    }
}

pub struct G2ScalarMulVerifier {
    params: G2ScalarMulParams,
...
impl allocative::Allocative for G2ScalarMulVerifier {
    fn visit<'a, 'b: 'a>(&self, _visitor: &'a mut allocative::Visitor<'b>) {}
}

impl G2ScalarMulVerifier {
    pub fn new<T: Transcript>(
        num_constraints: usize,
        ...
        let params = G2ScalarMulParams::new(num_constraints);
    ...
    pub fn new_with_k_common<T: Transcript>(
        ...
        debug_assert_eq!(public_inputs.len(), num_constraints);
        let params = G2ScalarMulParams::new_with_k_common(num_constraints, k_common);
        Self::new_with_params(params, num_constraints, public_inputs, transcript)
    }
...
impl<T: Transcript> SumcheckInstanceVerifier<Fq, T> for G2ScalarMulVerifier {
    fn get_params(&self) -> &dyn SumcheckInstanceParams<Fq> {
        &self.params
    }
    ...
    fn expected_output_claim(
        ...
        // Eq polynomial convention: reverse challenges (big-endian) for EqPolynomial::mle.
        ...
        // - base point is committed as (x_p_c0, x_p_c1, y_p_c0, y_p_c1) over (step,c)
        ...
        // Committed base point at this point (already batched over c by MLE evaluation).
        let x_p = Fq2::new(
        ...
        // Fetch opened claims (14 committed witness polynomials), without heap allocation.
        let vals = G2ScalarMulValues {
            x_a_c0: accumulator.get_virtual_polynomial_claim(
                VirtualPolynomial::Recursion(RecursionPoly::G2ScalarMul {
                    term: G2ScalarMulTerm::XAC0,
                }),
                SumcheckId::G2ScalarMul,
            ),
            x_a_c1: accumulator.get_virtual_polynomial_claim(
                VirtualPolynomial::Recursion(RecursionPoly::G2ScalarMul {
                    term: G2ScalarMulTerm::XAC1,
                }),
                SumcheckId::G2ScalarMul,
            ),
            y_a_c0: accumulator.get_virtual_polynomial_claim(
                VirtualPolynomial::Recursion(RecursionPoly::G2ScalarMul {
                    term: G2ScalarMulTerm::YAC0,
                }),
                SumcheckId::G2ScalarMul,
            ),
            y_a_c1: accumulator.get_virtual_polynomial_claim(
                VirtualPolynomial::Recursion(RecursionPoly::G2ScalarMul {
                    term: G2ScalarMulTerm::YAC1,
                }),
                SumcheckId::G2ScalarMul,
            ),
            x_t_c0: accumulator.get_virtual_polynomial_claim(
                VirtualPolynomial::Recursion(RecursionPoly::G2ScalarMul {
                    term: G2ScalarMulTerm::XTC0,
                }),
                SumcheckId::G2ScalarMul,
            ),
            x_t_c1: accumulator.get_virtual_polynomial_claim(
                VirtualPolynomial::Recursion(RecursionPoly::G2ScalarMul {
                    term: G2ScalarMulTerm::XTC1,
                }),
                SumcheckId::G2ScalarMul,
            ),
            y_t_c0: accumulator.get_virtual_polynomial_claim(
                VirtualPolynomial::Recursion(RecursionPoly::G2ScalarMul {
                    term: G2ScalarMulTerm::YTC0,
                }),
                SumcheckId::G2ScalarMul,
            ),
            y_t_c1: accumulator.get_virtual_polynomial_claim(
                VirtualPolynomial::Recursion(RecursionPoly::G2ScalarMul {
                    term: G2ScalarMulTerm::YTC1,
                }),
                SumcheckId::G2ScalarMul,
            ),
            x_a_next_c0: accumulator.get_virtual_polynomial_claim(
                VirtualPolynomial::Recursion(RecursionPoly::G2ScalarMul {
                    term: G2ScalarMulTerm::XANextC0,
                }),
                SumcheckId::G2ScalarMul,
            ),
            x_a_next_c1: accumulator.get_virtual_polynomial_claim(
                VirtualPolynomial::Recursion(RecursionPoly::G2ScalarMul {
                    term: G2ScalarMulTerm::XANextC1,
                }),
                SumcheckId::G2ScalarMul,
            ),
            y_a_next_c0: accumulator.get_virtual_polynomial_claim(
                VirtualPolynomial::Recursion(RecursionPoly::G2ScalarMul {
                    term: G2ScalarMulTerm::YANextC0,
                }),
                SumcheckId::G2ScalarMul,
            ),
            y_a_next_c1: accumulator.get_virtual_polynomial_claim(
                VirtualPolynomial::Recursion(RecursionPoly::G2ScalarMul {
                    term: G2ScalarMulTerm::YANextC1,
                }),
                SumcheckId::G2ScalarMul,
    ...
    fn cache_openings(
        ...
        for vp in [
            ...
            accumulator.append_virtual(transcript, vp, SumcheckId::G2ScalarMul, op);
        }
    }
}

#[derive(Clone, Debug, Allocative)]
pub struct ShiftG2ScalarMulParams {
    pub num_step_vars: usize, // 8
    pub k_smul: usize,
    pub k_common: usize,
}

impl ShiftG2ScalarMulParams {
    pub fn new(num_constraints: usize) -> Self {
...
#[derive(Allocative)]
pub struct ShiftG2ScalarMulProver {
...
impl ShiftG2ScalarMulProver {
    pub fn new<T: Transcript>(rows: &[G2ScalarMulNative], transcript: &mut T) -> Self {
        let params = ShiftG2ScalarMulParams::new(rows.len());
    ...
    pub fn new_with_k_common<T: Transcript>(
        ...
        let params = ShiftG2ScalarMulParams::new_with_k_common(rows.len(), k_common);
        Self::new_with_params(rows, params, transcript)
    }
...
impl<T: Transcript> SumcheckInstanceProver<Fq, T> for ShiftG2ScalarMulProver {
    fn degree(&self) -> usize {
...
#[derive(Allocative)]
pub struct ShiftG2ScalarMulVerifier {
    params: ShiftG2ScalarMulParams,
...
impl ShiftG2ScalarMulVerifier {
    pub fn new<T: Transcript>(num_constraints: usize, transcript: &mut T) -> Self {
        let params = ShiftG2ScalarMulParams::new(num_constraints);
    ...
    pub fn new_with_k_common<T: Transcript>(
        ...
        let params = ShiftG2ScalarMulParams::new_with_k_common(num_constraints, k_common);
        Self::new_with_params(params, transcript)
    }
...
impl<T: Transcript> SumcheckInstanceVerifier<Fq, T> for ShiftG2ScalarMulVerifier {
    fn degree(&self) -> usize {
        4
    }
    ...
    fn expected_output_claim(
        ...
        let xa0 = accumulator.get_virtual_polynomial_claim(
            VirtualPolynomial::Recursion(RecursionPoly::G2ScalarMul {
                term: G2ScalarMulTerm::XAC0,
            }),
            SumcheckId::G2ScalarMul,
        );
        let xa1 = accumulator.get_virtual_polynomial_claim(
            VirtualPolynomial::Recursion(RecursionPoly::G2ScalarMul {
                term: G2ScalarMulTerm::XAC1,
            }),
            SumcheckId::G2ScalarMul,
        );
        let ya0 = accumulator.get_virtual_polynomial_claim(
            VirtualPolynomial::Recursion(RecursionPoly::G2ScalarMul {
                term: G2ScalarMulTerm::YAC0,
            }),
            SumcheckId::G2ScalarMul,
        );
        let ya1 = accumulator.get_virtual_polynomial_claim(
            VirtualPolynomial::Recursion(RecursionPoly::G2ScalarMul {
                term: G2ScalarMulTerm::YAC1,
            }),
            SumcheckId::G2ScalarMul,
        );
        let xan0 = accumulator.get_virtual_polynomial_claim(
            VirtualPolynomial::Recursion(RecursionPoly::G2ScalarMul {
                term: G2ScalarMulTerm::XANextC0,
            }),
            SumcheckId::G2ScalarMul,
        );
        let xan1 = accumulator.get_virtual_polynomial_claim(
            VirtualPolynomial::Recursion(RecursionPoly::G2ScalarMul {
                term: G2ScalarMulTerm::XANextC1,
            }),
            SumcheckId::G2ScalarMul,
        );
        let yan0 = accumulator.get_virtual_polynomial_claim(
            VirtualPolynomial::Recursion(RecursionPoly::G2ScalarMul {
                term: G2ScalarMulTerm::YANextC0,
            }),
            SumcheckId::G2ScalarMul,
        );
        let yan1 = accumulator.get_virtual_polynomial_claim(
            VirtualPolynomial::Recursion(RecursionPoly::G2ScalarMul {
                term: G2ScalarMulTerm::YANextC1,
            }),
            SumcheckId::G2ScalarMul,
