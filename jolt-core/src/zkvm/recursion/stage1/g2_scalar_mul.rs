...
fn append_g2_scalar_mul_virtual_claims<F: JoltField, T: Transcript>(
    ...
    let claims = virtual_claims![
        VirtualPolynomial::g2_scalar_mul_xa_c0(constraint_idx) => x_a_c0_claim,
        VirtualPolynomial::g2_scalar_mul_xa_c1(constraint_idx) => x_a_c1_claim,
        VirtualPolynomial::g2_scalar_mul_ya_c0(constraint_idx) => y_a_c0_claim,
        VirtualPolynomial::g2_scalar_mul_ya_c1(constraint_idx) => y_a_c1_claim,
        VirtualPolynomial::g2_scalar_mul_xt_c0(constraint_idx) => x_t_c0_claim,
        VirtualPolynomial::g2_scalar_mul_xt_c1(constraint_idx) => x_t_c1_claim,
        VirtualPolynomial::g2_scalar_mul_yt_c0(constraint_idx) => y_t_c0_claim,
        VirtualPolynomial::g2_scalar_mul_yt_c1(constraint_idx) => y_t_c1_claim,
        VirtualPolynomial::g2_scalar_mul_xa_next_c0(constraint_idx) => x_a_next_c0_claim,
        VirtualPolynomial::g2_scalar_mul_xa_next_c1(constraint_idx) => x_a_next_c1_claim,
        VirtualPolynomial::g2_scalar_mul_ya_next_c0(constraint_idx) => y_a_next_c0_claim,
        VirtualPolynomial::g2_scalar_mul_ya_next_c1(constraint_idx) => y_a_next_c1_claim,
        VirtualPolynomial::g2_scalar_mul_t_indicator(constraint_idx) => t_is_infinity_claim,
        VirtualPolynomial::g2_scalar_mul_a_indicator(constraint_idx) => a_is_infinity_claim,
    ];
...
fn get_g2_scalar_mul_virtual_claims<F: JoltField>(
    ...
    let polynomials = vec![
        VirtualPolynomial::g2_scalar_mul_xa_c0(constraint_idx),
        VirtualPolynomial::g2_scalar_mul_xa_c1(constraint_idx),
        VirtualPolynomial::g2_scalar_mul_ya_c0(constraint_idx),
        VirtualPolynomial::g2_scalar_mul_ya_c1(constraint_idx),
        VirtualPolynomial::g2_scalar_mul_xt_c0(constraint_idx),
        VirtualPolynomial::g2_scalar_mul_xt_c1(constraint_idx),
        VirtualPolynomial::g2_scalar_mul_yt_c0(constraint_idx),
        VirtualPolynomial::g2_scalar_mul_yt_c1(constraint_idx),
        VirtualPolynomial::g2_scalar_mul_xa_next_c0(constraint_idx),
        VirtualPolynomial::g2_scalar_mul_xa_next_c1(constraint_idx),
        VirtualPolynomial::g2_scalar_mul_ya_next_c0(constraint_idx),
        VirtualPolynomial::g2_scalar_mul_ya_next_c1(constraint_idx),
        VirtualPolynomial::g2_scalar_mul_t_indicator(constraint_idx),
        VirtualPolynomial::g2_scalar_mul_a_indicator(constraint_idx),
    ];
