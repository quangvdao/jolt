...
pub fn assert_bolt_full_real_trace_self_parity(
    ...
    let mut core_lookup_params = fixture.params.clone();
    core_lookup_params.lookup_table_count = fixture.stage6_num_lookup_tables;
    let (stage5_prover_program, stage5_verifier_program) =
        bolt_stage5_programs_with_params(&core_lookup_params);
    let (stage6_prover_program, stage6_verifier_program) =
        bolt_stage6_programs_with_params(&core_lookup_params);
